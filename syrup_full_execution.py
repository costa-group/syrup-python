...
import json
from solver_solution_verify import generate_solution_dict
...
def init():
    ...
    global log_file
    log_file = tmp_costabs + "blocks_log.log"
...
def main():
    ...
    parser.add_argument("-check-log-file", dest='log_path', action='store',
