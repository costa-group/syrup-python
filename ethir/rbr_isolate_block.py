...
from ethir.ebso_optimization import smt_translate_isolate
...
'''
def evm2rbr_compiler(contract_name = None, ebso = None,block = None):
    global rbr_blocks
    global ebso_flag
    ...
    try:
        ...
        if ebso:
            smt_translate_isolate(rule,contract_name)
