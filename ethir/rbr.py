...
'''
def evm2rbr_compiler(blocks_input = None, stack_info = None, block_unbuild = None,saco_rbr = None,c_rbr = None, exe = None, contract_name = None, component = None, oyente_time = 0,scc = None,svc_labels = None,gotos=None,fbm = [], source_info = None,syrup = None,sname = None, sto = False):
    global rbr_blocks
    global stack_index
    global verticesd
    global c_trans
