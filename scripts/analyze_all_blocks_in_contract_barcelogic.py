...
def init():
    ...
    global syrup_flags
    syrup_flags = "-tout " + str(tout) + " -solver barcelogic"
    ...
    global barcelogic_flags
    barcelogic_flags = "-tlimit " + str(tout)
    ...
    global results_dir
    results_dir = project_path + "/results/prueba/barcelogic_" + str(tout) + "s/"
...
def analyze_file(solution):
    ...
    return submatch(solution), False
