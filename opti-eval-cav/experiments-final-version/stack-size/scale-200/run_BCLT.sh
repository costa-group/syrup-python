...
do
  ...
  /home/mschett/syrup-backend/run_BCLT.sh -timeout 900 -omit-csv-header -scale-sk-sz 200 $PATH_TO_INPUT > /home/mschett/syrup-eval/stack-size/scale-200/results/result_BCLT_${i}.json 2>&1
done
