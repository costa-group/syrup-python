...
do
  ...
  /home/mschett/syrup-backend/run_Z3.sh -timeout 900 -omit-csv-header -scale-sk-sz 200 $PATH_TO_INPUT > /home/mschett/syrup-eval/stack-size/scale-200/results/result_Z3_${i}.json 2>&1
done
