...
do
  ...
  /home/mschett/syrup-backend/run_Z3.sh -timeout 900 -omit-csv-header -scale-progr-len 200 $PATH_TO_INPUT > /home/mschett/syrup-eval/program-length/scale_200/results/result_Z3_${i}.json 2>&1
done
