...
do
  ...
  /home/mschett/syrup-backend/run_BCLT.sh -timeout 900 -omit-csv-header -scale-progr-len 200 $PATH_TO_INPUT > /home/mschett/syrup-eval/program-length/scale_200/results/result_BCLT_${i}.json 2>&1
done
