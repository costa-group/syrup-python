...
do
  ...
  /home/mschett/syrup-backend/run_BCLT.sh -timeout 900 -omit-csv-header -add-tgt-instr $PATH_TO_INPUT > /home/mschett/syrup-eval/redundant-clauses/at-most-once/results/result_BCLT_${i}.json 2>&1
done
