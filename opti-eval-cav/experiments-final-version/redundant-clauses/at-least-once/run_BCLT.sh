...
do
  ...
  /home/mschett/syrup-backend/run_BCLT.sh -timeout 900 -omit-csv-header -rm-tgt-instr $PATH_TO_INPUT > /home/mschett/syrup-eval/redundant-clauses/at-least-once/results/result_BCLT_${i}.json 2>&1
done
