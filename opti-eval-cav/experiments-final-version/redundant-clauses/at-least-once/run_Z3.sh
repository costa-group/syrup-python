...
do
  ...
  /home/mschett/syrup-backend/run_Z3.sh -timeout 900 -omit-csv-header -rm-tgt-instr $PATH_TO_INPUT > /home/mschett/syrup-eval/redundant-clauses/at-least-once/results/result_Z3_${i}.json 2>&1
done
