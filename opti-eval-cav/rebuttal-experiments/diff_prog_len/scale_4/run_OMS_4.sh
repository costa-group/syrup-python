...
do
  ...
  /home/mschett/opti/run_OMS.sh -timeout 900 -omit-csv-header -scale-progr-len 400 $PATH_TO_INPUT > /home/mschett/opti-eval/rebuttal-experiments/results-4/result_OMS_${i}.json 2>&1
done
